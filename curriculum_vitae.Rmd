...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, output_file = "index.html", encoding = encoding, output_dir = ".") })
---
...
Martial arts (3 years Karate, 2ans Judo), (*skills : rigor, respect and humility*). Roller (7 years, voluntary instructor for 6 years)
...
Volunteer at ["Institut Pasteur de Lille"](https://www.pasteur-lille.fr/accueil/). Voluntary tour guide at Guise castle, owner "Club du Vieux Manoir" (*skills : communication, clearness*). Voluntary teacher in spain refugee camp (1 month, 2013) (*skills: humility, patience, adaptation*)
